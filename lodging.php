                            ...
                            <div class="abt-imgs">
                                <div class="row">
                                        <div class="abt-img wow " data-wow-duration="400ms">
                                            ...
                                            <a href="https://www.kempinski.com/en/booking/select_room?hotelId=1100&clearBookingParams=1&room1Adults=1&startDate=2024-06-03&endDate=2024-06-07&promoCode=ANNU240606/" title="" class="html5lightbox">
                        ...
                        <div class="col-lg-8" style="padding: 10px 31px;">
                            <div class="blog-info">
                                ...
                                The Kempinski Hotel serves as the convenient and luxurious home base for this year&rsquo;s conference. Situated in the heart of Accra&rsquo;s business district, the hotel offers attendees easy access to key areas while remaining close to the city&rsquo;s vibrant cultural center.  </p>
                                    ...
                                    <p> 
								<a id="loadpage"  href="https://www.kempinski.com/en/booking/select_room?hotelId=1100&clearBookingParams=1&room1Adults=1&startDate=2024-06-03&endDate=2024-06-07&promoCode=ANNU240606">Click here to book your stay now</a>
								 <br>
								 <br>
...
-->
	  ...
	  <div id="hotels">
        <div class="row" data-aos-delay="100">
		  ...
		  <div id="accracity" class="modal fade" >
			<div class="modal-dialog accommodationmodal">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<a id="loadpage" type="button" class="btn btn-primary" href="https://direct-book.com/properties/accracityhotellimiteddirect?locale=en&from_widget=true&roomTypeId=&checkInDate=2024-06-03&checkOutDate=2024-06-06&referrer=canvas&items[0][adults]=1&items[0][children]=0&items[0][infants]=0&currency=USD&trackPage=yes" style="display: inline-block; color: #ffffff; font-size: 18px; font-weight: 700; text-transform: uppercase; height: 50px; line-height: 50px; padding: 0 25px; -webkit-border-radius: 10px; -ms-border-radius: 10px; border-radius: 10px;">Book a Room</a>
			...
			<div class="modal-dialog accommodationmodal">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<p>
							<h3>
								...
								<ul>
									<li>Options are available from as low as $29 per night</li>
								</ul>
								<br>
					...
					<div class="modal-footer">
						...
						<a id="loadpage" type="button" class="btn btn-primary" href="https://www.airbnb.com/s/Kempinski-Hotel-Gold-Coast-City-Accra--Gamel-Abdul-Nasser-Avenue--Accra--Ghana/homes?tab_id=home_tab&refinement_paths%5B%5D=%2Fhomes&flexible_trip_lengths%5B%5D=one_week&monthly_start_date=2024-05-01&monthly_length=3&monthly_end_date=2024-08-01&price_filter_input_type=0&channel=EXPLORE&query=Kempinski%20Hotel%20Gold%20Coast%20City%20Accra%2C%20Accra&place_id=ChIJAcTuKJuQ3w8Rl38ROfnzGGo&date_picker_type=calendar&checkin=2024-06-03&checkout=2024-06-06&source=structured_search_input_header&search_type=autocomplete_click" style="display: inline-block; color: #ffffff; font-size: 18px; font-weight: 700; text-transform: uppercase; height: 50px; line-height: 50px; padding: 0 25px; -webkit-border-radius: 10px; -ms-border-radius: 10px; border-radius: 10px;">Book an AirBnB</a>
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					</div>
				</div>
				<!-- /.modal-content -->
